...
int main()
{
    ...
    Model woman_model("scene/woman/woman.obj");
    Model room_model("scene/room/room.obj");
    Model test_cube("scene/test_cube/test_cube.obj");
